                ...
                <table id="example1" class="table table-bordered table-striped small">
                  ...
                  <tbody>
                   ...
                   $tampil = mysqli_query($con, "SELECT * FROM hasil 
                    ...
                    INNER JOIN user ON user.id_user = hasil.id_user
                    ...
                    <tr>
                      ...
                      <td>
                       <div class="btn-group">
                        ...
                        <button style="width: 25px;" type="button" class="btn btn-xs btn-dark" onclick="window.location.href='cetakhasildiagnosa?id_hasil=<?php echo $ide;?>'"><i class="fa fa-print faa-tada animation-hover"></i></button>
