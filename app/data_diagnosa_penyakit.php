        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             <?php
             $ids=$_GET['ids'];
             $ru=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM user WHERE id_user = '$ids'"));
             ?>
             <div class="row">
               <div class="col-md-6">
            ...
            <div class="col-md-12">
              <center>
                ...
                <form class="col-6" method="POST" action="prosesdiagnosapenyakit?ids=<?php echo "$ru[id_user]"; ?>">
