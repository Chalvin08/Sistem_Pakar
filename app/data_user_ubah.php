        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              $r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM user WHERE id_user = '$idd'"));
              ?>
              <form class='form-horizontal' role='form' method=POST action='act/data_user_update.php' enctype='multipart/form-data'>
