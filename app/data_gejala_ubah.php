        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-edit"></i> Form Ubah Data Gejala</h3>
            ...
            <div class="card-body">
              ...
              $r=mysqli_fetch_array(mysqli_query($con, "SELECT * FROM tb_gejala_1 WHERE id= '$idd'"));
              ?>
              <form class='form-horizontal' role='form' method=POST action='act/data_gejala_update.php' enctype='multipart/form-data'>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-border" placeholder="Tuliskan Kode gejala" value="<?php echo "$r[kode]"; ?>" name="kode">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Nama gejala</label>
                      <input type="text" class="form-control form-control-border" placeholder="Tuliskan Nama gejala" value="<?php echo "$r[gejala]"; ?>" name="gejala">
                    </div>
                  </div>
                </div>
              </div>
