<div class="col-md-12">
  ...
  <form class='form-horizontal' role='form' method='POST' action='act/user_diagnosa_save.php' enctype='multipart/form-data'>
    ...
    <div class="btn-group">
      ...
      <a href="./diagnosa" class="btn btn-warning"><i class="fa fa-arrow-circle-left"></i> Diagnosa Kembali</a>
    </div>
  </form>
  <script>
    function myFunction() {
